...
export interface CallableFlowOperand {
     ...
     */
    readonly expressionKind?: 'binding' | 'callable-designator' | 'bound-member' | 'anonymous-callable';
...
export type CallableFlowSite = CallableFlowSeedSite | CallableFlowCopySite | CallableFlowAliasSite | CallableFlowAddressSite | CallableFlowStoreSite | CallableFlowLoadSite | CallableFlowFormalSite | CallableFlowArgumentSite | CallableFlowInvokeSite;
//# sourceMappingURL=callable-flow-site.d.ts.map