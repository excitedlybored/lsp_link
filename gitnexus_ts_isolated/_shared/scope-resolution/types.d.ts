 ...
 */
export type ScopeKind = 'Module' | 'Namespace' | 'Class' | 'Function' | 'Block' | 'Expression' | 'Object';
...
export interface ImportEdge {
    ...
    readonly kind: 'named' | 'alias' | 'namespace' | 'wildcard-expanded' | 'reexport' | 'dynamic-unresolved' | 'dynamic-resolved' | 'side-effect';
...
export interface Reference {
    ...
    readonly kind: 'call' | 'read' | 'write' | 'type-reference' | 'inherits' | 'import-use' | 'value-ref' | 'macro';
    readonly confidence: number;
    readonly evidence: readonly ResolutionEvidence[];
}
/**
