...
export declare const LEGACY_METADATA_FILE = "meta.json";
/**
...
export interface RepoMeta {
     ...
     */
    crossLanguageProperties?: readonly {
        name: string;
        languages: string[];
    }[];
    graphWriteCollapsed?: {
 ...
 */
export declare function isMissingFilesystemError(err: unknown): boolean;
/**
 * Best-effort read of one specific metadata filename — no fallback, null on
 * any failure (absent, unreadable, or unparseable).
 */
export declare const tryReadMetaFile: (dir: string, filename: string) => Promise<RepoMeta | null>;
/**
 ...
 */
export declare const loadMeta: (metaDir: string) => Promise<RepoMeta | null>;
