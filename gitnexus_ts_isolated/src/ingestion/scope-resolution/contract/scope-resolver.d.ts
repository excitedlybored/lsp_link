...
import type { BindingRef, Callsite, ConstraintContext, ParsedFile, ParsedImport, ReferenceSite, ScopeId, SupportedLanguages, SymbolDefinition } from '../../../../_shared/index.js';
...
export interface ScopeResolver {
     ...
     */
    resolveImportTarget(targetRaw: string, fromFile: string, allFilePaths: ReadonlySet<string>, resolutionConfig?: unknown, context?: ImportResolutionContext): string | readonly string[] | null;
    /**
     ...
     */
    readonly expandsWildcardTo?: (targetModuleScope: ScopeId, parsedFiles: readonly ParsedFile[]) => readonly string[];
    /**
     ...
     */
    readonly emitHeritageEdges?: (graph: KnowledgeGraph, parsedFiles: readonly ParsedFile[], nodeLookup: GraphNodeLookup, scopes?: ScopeResolutionIndexes, recordTypeArguments?: HeritageTypeArgumentSink) => void;
    /**
     ...
     */
    readonly emitImplicitImportEdges?: (graph: KnowledgeGraph, parsedFiles: readonly ParsedFile[], nodeLookup: GraphNodeLookup, resolutionConfig?: unknown) => void;
    /**
     ...
     */
    readonly isSuperReceiverInContext?: (receiverText: string, callerScope: ScopeId, scopes: ScopeResolutionIndexes) => boolean;
    /**
     ...
     * this undefined.
     */
    readonly resolveQualifiedFreeCall?: (site: {
        readonly name: string;
     ...
     */
    readonly namespaceReceiverPaths?: (edge: {
        readonly localName: string;
        readonly importPath: string;
        readonly targetFile: string;
    }, moduleFileExists: (filePath: string) => boolean) => readonly (readonly [spelling: string, targetFile: string])[] | undefined;
    /**
     ...
     */
    readonly detectInterfaceImplementations?: (parsedFiles: readonly ParsedFile[], indexes: ScopeResolutionIndexes, model: SemanticModel) => StructuralImplementationResult;
    /**
     ...
     */
    readonly mirrorNamespaceTypeBindings?: (parsedFiles: readonly ParsedFile[], indexes: ScopeResolutionIndexes, workspaceIndex: import('../../scope-resolution/workspace-index.js').WorkspaceResolutionIndex, resolutionConfig?: unknown) => void;
    /**
     ...
     */
    readonly populateRangeBindings?: (parsedFiles: readonly ParsedFile[], indexes: ScopeResolutionIndexes, ctx: {
        readonly fileContents: ReadonlyMap<string, string>;
        readonly treeCache?: {
            get(filePath: string): unknown;
        };
    ...
    readonly collectScopeContextPaths?: (options: {
        ...
        readonly preExtractedByPath: ReadonlyMap<string, import('../../../../_shared/index.js').ParsedFile>;
     ...
     */
    readonly emitPostResolutionEdges?: (graph: KnowledgeGraph, parsedFiles: readonly ParsedFile[], nodeLookup: GraphNodeLookup, indexes: ScopeResolutionIndexes, ctx: {
        readonly fileContents: ReadonlyMap<string, string>;
        readonly resolutionConfig?: unknown;
    }) => void;
    /**
