import type { Range, ReferenceKind } from '../../../_shared/index.js';
import type { DecodedReceiverChain } from '../utils/receiver-chain-codec.js';
export type ResolutionSuppressionReason = 'adl-ordinary-lookup-blocked' | 'conversion-rank-tied' | 'inline-ns-ambiguous' | 'member-lookup-ambiguous' | 'selected-callable-deleted' | 'overload-ambiguous' | 'overload-ambiguous-normalization' | 'free-call-instance-ownership'
 ...
 */
export type ReceiverShape = 'chain-call' | 'chain-field' | 'chain-mixed' | 'chain-unwrap' | 'no-chain';
/**
...
export declare function classifyReceiverShape(decoded: DecodedReceiverChain | undefined): ReceiverShape;
