 ...
 *  identically. */
export declare function calleeIdPosKey(line: number, col: number): CalleeIdPosKey;
/**
 ...
 */
export declare function createCalleeIdAccumulator(shouldCapture?: CalleeIdCaptureFilter): CalleeIdAccumulator;
