...
const pythonScopeResolver = {
    ...
    resolveImportTarget: (targetRaw, fromFile, allFilePaths, _resolutionConfig, context) => {
        ...
        return resolvePythonImportTarget(context?.parsedImport ?? { kind: 'namespace', localName: '_', importedName: '_', targetRaw }, ws);
    },
    isNamespaceImport: (parsedImport, targetFile, fromFile) => isPythonImportedModule(parsedImport, targetFile, fromFile),
