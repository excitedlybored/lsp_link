 ...
 */
import { findAncestorBeforeBoundary, findChild, nodeToCapture, syntheticCapture, } from '../../utils/ast-helpers.js';
/**
 ...
 */
const PUBLICATION_SUPPRESSING_ANCESTORS = new Set([
    'function_definition',
    'class_definition',
]);
const NO_BOUNDARY = new Set();
...
function splitImportFromStmt(stmtNode) {
    ...
    const publishesToModule = findAncestorBeforeBoundary(stmtNode, PUBLICATION_SUPPRESSING_ANCESTORS, NO_BOUNDARY) === null;
