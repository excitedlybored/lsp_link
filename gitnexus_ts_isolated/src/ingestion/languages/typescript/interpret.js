...
const NO_TYPE_ONLY = Object.freeze({});
// ─── interpretImport ──────────────────────────────────────────────────────
export function interpretTsImport(captures) {
    ...
    const typeOnly = captures['@import.type-only'] !== undefined ? { typeOnly: true } : NO_TYPE_ONLY;
    switch (kind) {
        case 'default': {
 ...
 */
export function reducesToContainedType(text) {
