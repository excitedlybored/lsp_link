...
import { isShadowedCjsExportAssignment, isUnexportedMemberAssignmentValue, isUndeclarableThisMemberValue, } from './cjs-export-assignment.js';
...
export const TS_CLASS_FIELD_DEFINITION_TYPES = new Set([
 ...
 */
export function isStaticClassFieldBinding(anchorNode, fieldDefinitionTypes) {
...
export function emitTsScopeCaptures(sourceText, filePath, cachedTree) {
    ...
    for (const m of rawMatches) {
        ...
        if (isStaticClassFieldBinding(groupedNodes['@type-binding.constructor'], TS_CLASS_FIELD_DEFINITION_TYPES) ||
            isStaticClassFieldBinding(groupedNodes['@type-binding.annotation'], TS_CLASS_FIELD_DEFINITION_TYPES)) {
            continue;
        }
