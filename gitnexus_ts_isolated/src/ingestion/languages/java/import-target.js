...
import { buildJavaPackageIndex, resolveJavaModule, } from './module-resolution.js';
/**
 ...
 */
const getJavaPackageIndex = perFileSet((parsedFiles) => buildJavaPackageIndex(parsedFiles, getJavaPackageFact));
