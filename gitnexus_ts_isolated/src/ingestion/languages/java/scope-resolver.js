...
import { applyJavaCaptureSideChannel, clearJavaClassAnnotationFacts, } from './capture-side-channel.js';
...
const javaScopeResolver = {
    ...
    resolveImportTarget: (targetRaw, fromFile, allFilePaths, _resolutionConfig, context) => {
        ...
        const ws = { fromFile, allFilePaths, parsedFiles: context?.parsedFiles };
