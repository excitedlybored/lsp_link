function isSpringApplicationConfig(filePath) {
...
export const SPRING_CONFIG_BINDINGS_FEATURE = {
    ...
    appliesTo: (filePaths) => filePaths.some((filePath) => filePath.toLowerCase().endsWith('.java') || isSpringApplicationConfig(filePath)),
};
/** Durable completeness contract for implicit Java record-component accessors. */
export const JAVA_RECORD_COMPONENT_ACCESSORS_FEATURE = {
...
export const JAVA_ENUM_INTERFACE_HERITAGE_FEATURE = {
