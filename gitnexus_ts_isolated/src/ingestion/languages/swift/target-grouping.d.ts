 ...
 */
export declare function groupSwiftFilesBySpmTarget<T>(items: readonly T[], getPath: (item: T) => string, targets: ReadonlyMap<string, string> | null): Map<string, T[]>;
/**
 ...
 */
export declare function coerceSwiftTargets(resolutionConfig: unknown): ReadonlyMap<string, string> | null;
