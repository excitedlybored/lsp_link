...
export function swiftBindingScopeFor(decl, innermost, tree) {
...
export function swiftImportOwningScope(_imp, innermost, _tree) {
...
export function swiftReceiverBinding(functionScope) {
