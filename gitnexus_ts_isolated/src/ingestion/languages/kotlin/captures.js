...
import { setKotlinClassAnnotationFacts, setKotlinSpringAopFacts, setKotlinSpringConditionalFacts, setKotlinSpringDiFacts, setKotlinSpringNonHttpHandlerFacts, } from './capture-side-channel.js';
import { captureKotlinPackageFact } from './package-facts.js';
import { synthesizeCallableFlowCaptures } from '../../utils/callable-flow-captures.js';
import { captureKotlinSpringDiClassFact } from './spring-di.js';
import { synthesizeReceiverChainCapture } from '../../utils/receiver-chain-captures.js';
import { captureKotlinSpringAopFacts } from './spring-aop.js';
import { captureKotlinSpringConditionalFacts, } from './spring-conditionals.js';
import { captureKotlinSpringNonHttpHandlerFacts, } from './spring-non-http-handlers.js';
...
export function emitKotlinScopeCaptures(sourceText, filePath, cachedTree) {
    ...
    const springNonHttpHandlerTypeNodeIds = new Set();
    ...
    for (const match of getKotlinScopeQuery().matches(tree.rootNode)) {
        ...
        if (springAopTypeNode !== undefined) {
            ...
            if (!springNonHttpHandlerTypeNodeIds.has(springAopTypeNode.id)) {
                ...
                springNonHttpHandlerFacts.push(...captureKotlinSpringNonHttpHandlerFacts(springAopTypeNode, filePath));
            }
        }
        ...
        if (springDiClassNode !== null && !springDiClassNodeIds.has(springDiClassNode.id)) {
            ...
            springConditionalFacts.push(...captureKotlinSpringConditionalFacts(springDiClassNode, filePath));
