import { isClassLike, populateClassOwnedMembers, tagNamespacePrefixes, } from '../../scope-resolution/scope/walkers.js';
/**
 ...
 *    same module).
 */
export function populateRustOwners(parsed) {
...
function populateRustImplOwners(parsed) {
    ...
    if (structByName.size === 0)
        return;
    const structBySuffix = new Map();
