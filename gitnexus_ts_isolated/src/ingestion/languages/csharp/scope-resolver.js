 ...
 */
const CSHARP_PREDEFINED_TYPE_ALIASES = new Map([
    ['bool', 'Boolean'],
    ['byte', 'Byte'],
    ['sbyte', 'SByte'],
    ['char', 'Char'],
...
const CSHARP_PREDEFINED_TYPE_NAMES = new Set(CSHARP_PREDEFINED_TYPE_ALIASES.values());
const CSHARP_SYSTEM_QUALIFIER = /^(?:global::)?System\./;
function normalizeCsharpTypeArgument(name) {
