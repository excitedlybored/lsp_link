...
export { markFileLocal, isFileLocal, clearFileLocalNames, expandCppWildcardNames, } from './file-local-linkage.js';
export { collectCppCaptureSideChannel, applyCppCaptureSideChannel, } from './capture-side-channel.js';
