...
import { classifyCppParameterType, computeCppDeclarationArity, computeCppCallArity, normalizeCppParamType, } from './arity-metadata.js';
...
export function emitCppScopeCaptures(sourceText, filePath, cachedTree) {
    ...
    for (const m of rawMatches) {
        ...
        if (declAnchorNode !== undefined) {
            const fnNode = nodeIfType(declAnchorNode, 'function_definition', 'declaration', 'field_declaration');
            if (fnNode !== null) {
        ...
        if (operatorAnchor !== undefined) {
            ...
            const operatorNode = callAnchorNode !== undefined ? nodeIfType(callAnchorNode, 'binary_expression') : null;
        ...
        if (operatorAnchor !== undefined && grouped['@reference.name'] === undefined) {
            ...
            grouped['@reference.name'] = syntheticCapture('@reference.name', tree.rootNode, `operator${operatorAnchor.text}`);
        }
        ...
        if (ctorCallAnchor !== undefined && grouped['@reference.arity'] === undefined) {
            ...
            if (newNode !== null) {
                grouped['@reference.arity'] = syntheticCapture('@reference.arity', newNode, String(computeCppCallArity(newNode)));
            }
        }
        ...
        if (anyCallAnchor !== undefined && grouped['@reference.parameter-types'] === undefined) {
            const cNode = nodeIfType(anyCallAnchorNode, 'call_expression', 'new_expression', 'binary_expression');
            if (cNode !== null) {
                    ...
                    if (valueNode !== null) {
                        if (valueNode.type === 'identifier') {
                            ...
                            if (argNode !== null && fieldNode !== null) {
                                ...
                                grouped['@type-binding.member-access-receiver'] = nodeToCapture('@type-binding.member-access-receiver', argNode);
                ...
                for (const base of iterBaseClasses(baseClause)) {
                    ...
                    out.push({
                        ...
                        ...(qualifiedBaseName.length > 0 && qualifiedBaseName !== baseName
                            ? {
                                '@reference.qualified-name': syntheticCapture('@reference.qualified-name', base.node, qualifiedBaseName),
                            }
                            : {}),
                    });
                }
...
function extractAdlTypeNamespace(typeNode) {
    ...
    if (typeNode.type === 'qualified_identifier') {
        ...
        if (scope !== null)
            return normalizeQualifiedName(scope.text);
