 ...
 */
export function computeCppDeclarationArity(node) {
    ...
    const requiredCount = params.filter((p) => p.type === 'parameter_declaration' ||
 ...
 */
export function computeCppCallArity(node) {
