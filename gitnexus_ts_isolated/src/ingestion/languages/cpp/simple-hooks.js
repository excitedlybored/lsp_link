 ...
 */
export function cppBindingScopeFor(decl, innermost, tree) {
 ...
 */
export function cppImportOwningScope(_imp, _innermost, _tree) {
    return null;
}
/**
 ...
 */
export function cppReceiverBinding(functionScope) {
    // Walk up the scope tree to find an enclosing class scope
    if (functionScope.parent === null)
        return null;
