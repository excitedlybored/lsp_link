...
export function splitGoImportStatement(node) {
    ...
    const kind = alias === '.' ? 'dot' : alias === '_' ? 'blank' : alias === undefined ? 'namespace' : 'alias';
    ...
    return [
        {
            ...
            '@import.name': syntheticCapture('@import.name', nameNode ?? pathNode, aliased ? alias : leaf),
