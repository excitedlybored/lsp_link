 ...
 */
export function interpretRubyImport(captures) {
 ...
 */
export function interpretRubyTypeBinding(captures) {
 ...
 *   4. Trim whitespace
 */
export function normalizeRubyTypeName(text) {
    let t = text.trim();
 ...
 */
function normalizeRubyConstructorType(text) {
    let t = text.trim();
