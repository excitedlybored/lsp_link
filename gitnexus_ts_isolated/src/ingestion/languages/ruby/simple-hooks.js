...
export function rubyBindingScopeFor(decl, innermost, tree) {
 ...
 */
export function rubyImportOwningScope(_imp, innermost, _tree) {
    if (innermost.kind === 'Function' || innermost.kind === 'Class') {
        return innermost.id;
    }
    return null;
}
export function rubyReceiverBinding(functionScope) {
 ...
 */
export function rubyFunctionDefinitionLabel(functionNode, defaultLabel) {
