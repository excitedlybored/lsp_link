 ...
 */
export function findEnclosingClassOrModule(node) {
    let cur = node.parent;
    while (cur !== null) {
        if (cur.type === 'program')
            return null;
 ...
 */
function extractClassName(classOrModuleNode) {
 ...
 */
export function synthesizeRubyReceiverBinding(fnNode, enclosingNode) {
