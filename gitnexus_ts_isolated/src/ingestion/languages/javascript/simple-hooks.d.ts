 ...
 */
import type { CaptureMatch, Scope, ScopeId, ScopeTree } from '../../../../_shared/index.js';
export { tsImportOwningScope as jsImportOwningScope, tsReceiverBinding as jsReceiverBinding, } from '../typescript/simple-hooks.js';
/**
 ...
 * `user.address.save()`.
 */
export declare function jsBindingScopeFor(decl: CaptureMatch, innermost: Scope, tree: ScopeTree): ScopeId | null;
