 ...
 */
export function buildPackageDirIndex(allFilePaths, accept) {
...
function* matchingDirs(index, pkgPath) {
    ...
    for (const dir of dirs) {
        if (dir !== pkgPath && !dir.endsWith(suffix))
            continue;
 ...
 */
export function filesDirectlyInPkgDir(index, pkgPath) {
...
export function sortedRootFiles(index) {
 ...
 */
export function firstFileDirectlyInPkgDir(index, pkgPath) {
