...
export declare const CALL_SUMMARY_CONFIDENCE = 0.6;
/** Default per-run cap on emitted `CALL_SUMMARY` edges. `0` ⇒ unlimited. */
export declare const DEFAULT_PDG_MAX_CALL_SUMMARY_EDGES = 0;
 ...
 */
export declare function emitCallSummaries(graph: KnowledgeGraph, summaries: readonly CallSummary[], limits?: CallSummaryEmitLimits, onWarn?: (message: string) => void): CallSummaryEmitResult;
