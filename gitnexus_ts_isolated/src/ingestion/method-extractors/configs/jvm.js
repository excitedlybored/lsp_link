...
import { extractAnnotations, findVisibility, hasModifier, } from '../../field-extractors/configs/helpers.js';
...
function kotlinParameterHasDefaultValue(param) {
 ...
 */
function extractKotlinMethodName(node) {
