...
export const isDebugHeapEnabled = () => parseTruthyEnv(process.env.GITNEXUS_DEBUG_HEAP) || isDeferredResolutionProfileEnabled();
export const heapUsedMb = () => Math.round(process.memoryUsage().heapUsed / 1024 / 1024);
 ...
 */
export const logHeapProbe = (label, detail) => {
