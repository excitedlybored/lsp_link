 ...
 */
export const normalizeQualifiedName = (value) => value
    .replace(/\s+/g, '')
    .replace(/^::/, '')
    .replace(/::/g, '.')
    .replace(/\\/g, '.')
 ...
 */
export const splitQualifiedName = (value) => {
 ...
 */
export function stripTrailingTypeArguments(value) {
    let depth = 0;
    let ltAt0 = -1;
