 ...
 */
export declare function isOverloadableCallable(label: NodeLabel | undefined): boolean;
/**
 ...
 */
export declare function isPositionQualifiedLocalLabel(label: NodeLabel | undefined): boolean;
