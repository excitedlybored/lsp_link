 ...
 */
export function calleesOfBlock(block) {
    const names = new Set();
 ...
 */
export function calleeIdsOfBlock(block, fileMap) {
...
export function emitFileCfgs(graph, cfgs, maxEdgesPerFunction = DEFAULT_MAX_CFG_EDGES_PER_FUNCTION, onWarn, calleeIdMap) {
