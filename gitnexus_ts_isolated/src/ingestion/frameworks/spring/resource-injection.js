import { normalizeSpringBeanType, parseSpringAnnotationArguments, parseStaticClassLiteral, parseStaticStringValues, } from './annotation-arguments.js';
export const SPRING_RESOURCE_ANNOTATIONS = new Set([
    'jakarta.annotation.Resource',
    'javax.annotation.Resource',
]);
function singleNamedArgument(annotationText, name) {
...
export function springResourceDefaultName(siteKind, memberName, dependencyCount) {
    if (siteKind !== 'method')
        return memberName;
...
export function springResourceInjectionMatch(annotationText, defaultName, rawDeclaredType, location) {
